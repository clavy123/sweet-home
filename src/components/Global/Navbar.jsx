    ...
    <>
      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-x-8">
          ...
          <Link
            to="/"
            className={`text-base font-medium ${styles.bgBlue} text-white px-5 py-2 rounded-full`}
          >
            List your property
          </Link>
        </div>
        <div className="flex items-center gap-4 lg:hidden">
          <button
            ...
            className="text-sm font-medium bg-blue-500 px-4 py-2 text-white rounded-full"
          >
            Login
          </button>
